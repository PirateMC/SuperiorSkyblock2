...
public enum Locale {
    ...
    COMMAND_DESCRIPTION_RAID_RESTORE,
    COMMAND_USAGE,
    COOP_ANNOUNCEMENT,
    COOP_BANNED_PLAYER,
    COOP_LIMIT_EXCEED,
    ...
    PLAYER_ALREADY_COOP,
    PLAYER_ALREADY_INVITED_TO_RAID,
    ...
    RAID_COOLDOWN_ACTIVE_OTHER,
    RAID_COOLDOWN_STARTED,
    RAID_COOLDOWN_STOPPED,
    RAID_COUNTDOWN,
    RAID_DRAW,
    RAID_INVITATION_DECLINED,
    RAID_INVITATION_DECLINED_OTHER,
    RAID_INVITATION_SENT,
    RAID_LOSE,
    RAID_START_COUNTDOWN,
    RAID_START,
    RAID_RESPAWN_COUNTDOWN,
    RAID_RESPAWN,
    RAID_UNKNOWN_COOLDOWN_OPTION,
    RAID_WIN,
    RANKUP_SUCCESS,
    RANKUP_SUCCESS_ALL,
    RANKUP_SUCCESS_NAME,
